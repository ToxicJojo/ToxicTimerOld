...
ToxicTimer.util.GetURLParameter = function (pParameter) {
...
ToxicTimer.util.Now = function () {
	var date = new Date();
	return date.getTime();
};

ToxicTimer.util.GetMillisecondsFromString = function (pTimeString) {
...
ToxicTimer.util.FormatTime = function (pMilliseconds) {
